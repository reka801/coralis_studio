				...
				<div class="card-wrapper">
					...
					<div class="card fat">
						<div class="card-body">
							...
							<form method="POST" action="/user/store" class="my-login-validation" novalidate="" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="profile_picture" type="file" class="form-control-file" name="profile_picture" accept="image/*" required>
                                    <div class="invalid-feedback">
